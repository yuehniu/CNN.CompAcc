...
(
    ...
    input  app_rdy_i,
    input  app_en_o,
    input  [3-1:0] app_cmd_o,
    input  [ADDR_WIDTH-1:0] app_addr_o,
    input  ddr3_wr_en_i,
    ...
    input  arbitor_ack_i,
    output app_rd_data_valid_i,
    output [DATA_WIDTH-1:0] app_rd_data_i,
    output app_rd_data_end_i,
