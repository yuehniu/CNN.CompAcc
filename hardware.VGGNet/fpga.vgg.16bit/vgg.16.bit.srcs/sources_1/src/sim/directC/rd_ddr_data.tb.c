...
//void readControl(U dataFullOrLoadingDone, U* readBottomData, U* bottomDataAddr,
//                 U* xEndPos, U* yEndPos, U* xPos, U* yPos, U* isFirstFM,
//                 U* ithOffset, U* barOffset, U* ithFM, U* readEnd )
